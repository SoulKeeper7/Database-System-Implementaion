...
const char *dbfile_dir = "/mnt/c/Users/agarw/Documents/P1/"; // dir where binary heap files should be stored
const char *tpch_dir ="/mnt/c/Users/agarw/Documents/P1/";///cise/tmp/dbi_sp11/DATA/10M/"; // dir where dbgen tpch files (extension *.tbl) can be found
