...
const char *dbfile_dir = "/mnt/c/Users/agarw/Downloads/10M/"; // dir where binary heap files should be stored
const char *tpch_dir ="/mnt/c/Users/agarw/Downloads/10M/"; // dir where dbgen tpch files (extension *.tbl) can be found
